  ...
  <div class="p-4">
    ...
    <form @submit.prevent="addProduct">
      <div class="mb-4">
        ...
        <input v-model="name" class="bg-blue-600 border rounded w-full p-2" />
      </div>
      <div class="mb-4">
        <label class="block text-sm font-bold mb-2">Price</label>
        <input type="number" v-model="price" class=" bg-blue-600 border rounded w-full p-2" />
      </div>
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <input type="number" v-model="discount" class="bg-blue-600  border rounded w-full p-2" />
      </div>
      <div class="mb-4">
        <label class="block text-sm font-bold mb-2">Category</label>
        <select v-model="selectedCategory" class="bg-blue-600 border rounded w-full p-2">
...
const addProduct = async () => {
  const category =
    selectedCategory.value === "new" ? newCategoryName.value : selectedCategory.value;
